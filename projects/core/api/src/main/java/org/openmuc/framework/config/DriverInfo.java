...
public class DriverInfo {
	...
	public DriverInfo(String id, String description, String deviceAddressSyntax, String parametersSyntax,
			String channelAddressSyntax, String deviceScanParametersSyntax) {
		this.id = id;

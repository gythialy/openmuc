...
public enum Flag {
    ...
    VALID(1), TIMEOUT(2), UNKNOWN_ERROR(3), DEVICE_OR_INTERFACE_BUSY(5), ACCESS_METHOD_NOT_SUPPORTED(6), NO_VALUE_RECEIVED_YET(
            ...
            26), CANNOT_WRITE_NULL_VALUE(27), DRIVER_ERROR_READ_FAILURE(28), CONNECTION_EXCEPTION(29);
    ...
    public static Flag newFlag(int code) {
        switch (code) {
            ...
            default:
                throw new IllegalArgumentException("Unknown Flag code: " + code + ". Specify" + " a valid code inbetween: 1-28");
        }
    }
}

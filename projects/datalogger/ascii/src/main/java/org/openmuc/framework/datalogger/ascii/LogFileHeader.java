...
public class LogFileHeader {
    ...
    private final static double ISEFORMATVERSION = 1.00;
    private final static String FILEINFO = "generated by AsciiLoger of OpenMUC";
     ...
     */
    public void writeIESDataFormatHeader(LogIntervalContainerGroup group, PrintStream out, String filename, int loggingInterval,
        ...
        if (out != null) {
            ...
            appendStrings(sb, "#ies_format_version: ", String.valueOf(ISEFORMATVERSION), "\n");
            appendStrings(sb, "#file: ", filename, "\n");
            appendStrings(sb, "#file_info: ", FILEINFO, "\n");
            ...
            appendStrings(sb, "#", "col_no", seperator, "col_name", seperator, "confidential", seperator, "measured", seperator, "unit",
                          seperator, "category", seperator, IESDataFormatUtils.COMMENT_NAME, "\n");
    ...
    private void createRow(StringBuilder sb, String col_no, String col_name, String confidential, String measured, String unit, String
        ...
        appendStrings(sb, com_sign, col_no, seperator, col_name, seperator, confidential, seperator, measured, seperator, unit, seperator,
                      category, seperator, valueType, vtSizeSep, valueTypeLengthString, vtEndSign, comment, "\n");
    }

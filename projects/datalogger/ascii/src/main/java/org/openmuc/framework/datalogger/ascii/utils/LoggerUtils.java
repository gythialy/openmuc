...
public class LoggerUtils {
     ...
     * @param calendar
     */
    public static void renameOldFiles(String directoryPath, Calendar calendar) {
     ...
     * @param calendar
     */
    public static void renameToOldFile(String directoryPath, String loggerIntervall_loggerTimeOffset, Calendar calendar) {
    ...
    public static void fillUpFileWithErrorCode(String directoryPath, String loggerIntervall_loggerTimeOffset, Calendar calendar) {
        ...
        if (raf != null) {
            try {
                ...
                if (firstLogLineLength != lastLogLineLength) {
                    ...
                    renameToOldFile(directoryPath, loggerIntervall_loggerTimeOffset, calendar);
                } else {
                    ...
                    while (numberOfFillUpLines > 0) {
                        ...
                        unixTimeStamp = fillUp(out, unixTimeStamp, loggingIntervall, lastLogLineLength, numberOfFillUpLines, errorValues);
    ...
    private static long fillUp(PrintWriter out, long unixTimeStamp, long loggingIntervall, int lastLogLineLength, long numberOfFillUpLines, StringBuilder errorValues) throws IOException {
    ...
    /**
     * @param errorValues has to be empty at begin
     * @param logLine
     * @return
     */
    ...
    private static int getByteStringLength(String string) {
        ...
        try {
            ...
            logger.warn("Not able to get ValueType length from String. Set length to minimal lenght " + Const.VALUE_SIZE_MINIMAL + ".");
            size = Const.VALUE_SIZE_MINIMAL;
        }
        return size;
    }

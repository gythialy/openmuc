...
public class LogFileReader {
    ...
    public List<Record> getValues(long startTimestamp, long endTimestamp) {
        ...
        List<String> filenames = LoggerUtils.getFilenames(loggingInterval, logTimeOffset, this.startTimestamp, this.endTimestamp);
    ...
    private boolean isNumber(String strValue) {
        ...
        if (!Character.isDigit(strValue.charAt(0)) && strValue.charAt(0) != Const.MINUS_SIGN && strValue.charAt(0) != Const.PLUS_SIGN) {
            return false;
        }

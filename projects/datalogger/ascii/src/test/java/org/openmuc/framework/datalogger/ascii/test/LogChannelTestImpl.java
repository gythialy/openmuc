...
public class LogChannelTestImpl implements LogChannel {
    ...
    public LogChannelTestImpl(String id, String description, String unit, ValueType valueType, Integer loggingInterval, Integer
            loggingTimeOffset) {
    ...
    public LogChannelTestImpl(String id, String description, String unit, ValueType valueType, Integer loggingInterval, Integer
            loggingTimeOffset, int valueLength) {

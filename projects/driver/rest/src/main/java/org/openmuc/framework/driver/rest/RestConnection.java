...
public class RestConnection implements Connection {
    ...
    public Record readChannel(String channelAddress, ValueType valueType) throws ConnectionException {
    ...
    public List<ChannelScanInfo> readChannels() throws ConnectionException {
    ...
    public void writeChannel(String channelAddress, Value value, ValueType valueType) throws ConnectionException {
        ...
        try {
            if (isHTTPS) {
                ...
                if (!(respCode >= 200 && respCode < 300)) {
                    throw new ConnectionException("HTTPS " + respCode + ":" + ((HttpsURLConnection) con).getResponseMessage());
                }
            } else {
                respCode = ((HttpURLConnection) con).getResponseCode();
                if (!(respCode >= 200 && respCode < 300)) {
                    throw new ConnectionException("HTTP " + respCode + ":" + ((HttpURLConnection) con).getResponseMessage());
                }
            }
        } catch (IOException e) {
            e.printStackTrace();
    ...
    @Override
    public Object read(List<ChannelRecordContainer> container, Object obj, String arg3) throws UnsupportedOperationException,
            ConnectionException {
    ...
    @Override
    public void startListening(List<ChannelRecordContainer> arg1, RecordsReceivedListener arg2) throws UnsupportedOperationException,
            ConnectionException {
    ...
    @Override
    public Object write(List<ChannelValueContainer> container, Object containerListHandle) throws UnsupportedOperationException, ConnectionException {

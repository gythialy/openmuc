...
class Configure {
     ...
     * Used to configure the RC1180 chip
     *
     * @param is     UART TDX pin
     * @param os     UART RDX pin
     * @param io     semaphore used to lock the input and output stream
     * @param logger
     */
     ...
     *
     * @param serialNumber byte array containing the serial number
     * @throws KNXException
     */
     ...
     *
     * @param domainAddress byte array containing the domain address
     * @throws KNXException
     */

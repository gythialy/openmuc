...
public class ModbusRTUConnection extends ModbusConnection {
    ...
    public ModbusRTUConnection(String deviceAddress, String[] settings, int timeout) throws ModbusConfigurationException {
    ...
    private SerialParameters setParameters(String address, String[] settings, int timeout) throws ModbusConfigurationException {
    ...
    private void checkIfAddressIsAvailbale(String address) throws ModbusConfigurationException {
        ...
        if (!result) {
            ...
            throw new ModbusConfigurationException(
                    "gnu.io.rxtx is unable to detect address: " + address + ". Available addresses are: '" + availablePorts + "'");
        }
    }

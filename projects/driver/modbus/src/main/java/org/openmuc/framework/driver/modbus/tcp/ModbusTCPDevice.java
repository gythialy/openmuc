...
public class ModbusTCPDevice extends ModbusDevice {

    private ModbusTCPConnection connection = null;
    private String slaveAddress;
    private int port;
    ModbusDriverUtil util;

    /**
     * @param deviceAddress e.g. ipadress, ipadress:port
     */
    public ModbusTCPDevice(String deviceAddress) {
        setAddress(deviceAddress);

        connection = new ModbusTCPConnection(slaveAddress, port);
    ...
    public void connect() throws ConnectionException {
        try {
            ...
            throw new ConnectionException(
                    "Unable to open Modbus connection for device with address " + slaveAddress
                    + " and port " + port);
        }
    }
     ...
     */
    private void setAddress(String deviceAddress) {

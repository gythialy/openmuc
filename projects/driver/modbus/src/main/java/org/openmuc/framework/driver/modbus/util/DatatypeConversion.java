...
public class DatatypeConversion {
     ...
     *
     * @param bytes  8 bytes where byte[0] is most significant byte and byte[7] is the least significant byte
     * @param endian endian byte order
     ...
     *
     * @param bytes  4 bytes where byte[0] is most significant byte and byte[3] is the least significant byte
     * @param endian endian byte order
     ...
     *
     * @param bytes  4 bytes where byte[0] is most significant byte and byte[3] least significant byte
     * @param endian endian byte order
     ...
     *
     * @param value  unsigned Int32 (long)
     * @param endian endian byte order
     ...
     *
     * @param bytes  2 bytes where byte[0] is most significant byte and byte[1] is the least significant byte
     * @param endian endian byte order
     * @return signed Int16
     */
     ...
     *
     * @param bytes  2 bytes where byte[0] is most significant byte and byte[1] least significant byte
     * @param endian endian byte order
     ...
     *
     * @param data  byte array which contains
     * @param index index of the byte which should be returned as unsigned int8. Index can be used for little and big
     *              endian support.

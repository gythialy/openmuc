...
*/	
	...
	[DllImport("libnodave.dll"/*, PreserveSig=false */ )]
	protected static extern int daveReadSZL(IntPtr dc,int id,int index,byte[] ddd);
...
//	[MarshalAs(UnmanagedType.LPStr)] string portName
    ...
    [DllImport("libnodave.dll"/*, PreserveSig=false */ )]
    public static extern string daveAreaName(int area);
    
    [DllImport("libnodave.dll"/*, PreserveSig=false */ )]
    public static extern string daveBlockName(int blockType);

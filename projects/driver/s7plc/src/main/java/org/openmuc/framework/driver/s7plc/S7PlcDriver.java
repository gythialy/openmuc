...
public final class S7PlcDriver implements DriverService {
    ...
    private final static DriverInfo info = new DriverInfo("s7plc", "Driver for WinAC / s7 PLC", "?", "?", "?", "?");
    ...
    public org.openmuc.framework.driver.spi.Connection connect(String deviceAddress, String settings) throws ArgumentSyntaxException,
        ...
        Interface ifc;
        try {
            ifc = new Interface("IF" + c, deviceAddress.substring(0, index), Integer.parseInt(deviceAddress.substring(index + 1)));

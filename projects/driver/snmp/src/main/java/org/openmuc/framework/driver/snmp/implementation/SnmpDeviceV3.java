...
public class SnmpDeviceV3 extends SnmpDevice {
    ...
    public String getSettings() {
        String settings = SnmpDriverSettingVariableNames.SNMPVersion
                .toString() + "=" + SNMPVersion.V3 + ":" + SnmpDriverSettingVariableNames.USERNAME + "=" + username + ":" + SnmpDriverSettingVariableNames.SECURITYNAME + "=" + securityName + ":" + SnmpDriverSettingVariableNames.AUTHENTICATIONPASSPHRASE + "=" + authenticationPassphrase + ":" + SnmpDriverSettingVariableNames.PRIVACYPASSPHRASE + "=" + privacyPassphrase;

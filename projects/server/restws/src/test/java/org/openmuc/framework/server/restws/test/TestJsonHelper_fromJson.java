...
public class TestJsonHelper_fromJson {
    ...
    public static void setup() {
        ...
        String testRecord = "\"" + Const.RECORD + "\":{\"timestamp\":" + Constants.TIMESTAMP + ",\"flag\":\"" + Constants.TEST_FLAG
                .toString() + "\",";
    ...
    public void test_jsonToRecord() {
        ...
        while (it.hasNext()) {
            ...
            if (record.getFlag().compareTo(Constants.TEST_FLAG) != 0) {
                result = false;
                System.out.println(
                        testMethodName + ": result is \"" + result + "\"; error: Record flag is wrong. Should be " + Constants.TEST_FLAG + " but is " + record
                                .getFlag());
                break;
            }

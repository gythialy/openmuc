            ...
            if (pathInfo.equals("/")) {
                ...
                if (pathInfoArray.length == 1) {
                    ...
                    if (userID.equalsIgnoreCase(Const.GROUPS)) {
                        ...
                        ServletLib.sendHTTPErrorAndLogDebug(response, HttpServletResponse.SC_NOT_FOUND, logger, "User does not exist.",
                                                            " User = ", userID);
                    }
        ...
        if (pathAndQueryString != null) {
            ...
            if (pathInfo.equals("/")) {
                ...
                if (authenticationService.contains(userConfig.getId())) {
                    ServletLib.sendHTTPErrorAndLogDebug(response, HttpServletResponse.SC_NOT_FOUND, logger, "User already exists.",
                                                        " User = ", userConfig.getId());
            ...
            if (pathInfo.equals("/")) {
                ...
                if (userConfig.getPassword() == null || userConfig.getPassword().equals("")) {
                    ...
                    if (authenticationService.login(id, userConfig.getOldPassword())) {
                        ...
                        ServletLib
                                .sendHTTPErrorAndLogDebug(response, HttpServletResponse.SC_UNAUTHORIZED, logger, "Old password is wrong.");
                    }
                } else {
                    ServletLib.sendHTTPErrorAndLogDebug(response, HttpServletResponse.SC_NOT_FOUND, logger, "User does not exist.",
                                                        " User = ", userConfig.getId());
        ...
        if (pathAndQueryString != null) {
            ...
            if (pathInfo.equals("/")) {
                ...
                if (authenticationService.contains(userID)) {
                    ...
                    ServletLib
                            .sendHTTPErrorAndLogDebug(response, HttpServletResponse.SC_NOT_FOUND, logger, "Requested user does not exist.",
                                                      " User = ", userID);
                }
            } else {
                ServletLib.sendHTTPErrorAndLogDebug(response, HttpServletResponse.SC_NOT_FOUND, logger,

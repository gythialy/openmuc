...
public class DeviceResourceServlet extends GenericServlet {
                ...
                try {
                    ...
                    if (rootConfig.getDriver(deviceID) == null) {
                        ...
                        ServletLib.sendHTTPErrorAndLogErr(response, HttpServletResponse.SC_INTERNAL_SERVER_ERROR, logger,
                                                          "Not able to delete driver ", deviceID);
                    }
    ...
    private List<ChannelScanInfo> scanForAllChannels(String deviceID, String settings, HttpServletResponse response) {
        ...
        List<ChannelScanInfo> channelList = new ArrayList<ChannelScanInfo>();
        ...
        try {
            ...
            ServletLib
                    .sendHTTPErrorAndLogDebug(response, HttpServletResponse.SC_NOT_FOUND, logger, "Requested rest device is not available.",
                                              " deviceId = ", deviceID);
    ...
    private List<Channel> doGetDeviceChannelList(String deviceID) {
        ...
        List<Channel> deviceChannelList = new ArrayList<Channel>();
    ...
    private boolean setAndWriteDeviceConfig(String deviceID, HttpServletResponse response, FromJson json, boolean isHTTPPut) {
        ...
        try {
            ...
            ServletLib.sendHTTPErrorAndLogErr(response, HttpServletResponse.SC_CONFLICT, logger, "Could not write device \"", deviceID,
                                              "\".");
            e.printStackTrace();
    ...
    private boolean setAndWriteHttpPutDeviceConfig(String deviceID, HttpServletResponse response, FromJson json) throws JsonSyntaxException, ConfigWriteException, RestConfigIsNotCorrectException, MissingJsonObjectException, IllegalStateException {
        ...
        if (deviceConfig != null) {
            ...
            ServletLib
                    .sendHTTPErrorAndLogErr(response, HttpServletResponse.SC_INTERNAL_SERVER_ERROR, logger, "Not able to access to device ",
                                            deviceID);
        }
        return ok;
    }

    private boolean setAndWriteHttpPostDeviceConfig(String deviceID, HttpServletResponse response, FromJson json) throws JsonSyntaxException, ConfigWriteException, RestConfigIsNotCorrectException, Error, MissingJsonObjectException, IllegalStateException {

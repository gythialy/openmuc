    ...
    public static Boolean start(int code, String[] args) {
        ...
        case 8:
            if (param == null) {
                ...
                System.out.println(
                        "If option -a (--all) is used you do not have to specify channels.");
                return false;
            }
        case 16:
            ArrayList<String> hParam = ClientStarter.getParameters(new Option('H', "history", ""),
                                                                   args);
            if (param == null) {
                System.out.println(
                        "Enter at least one channelId as parameter for option -c (--channel) ");
                return false;
            } else if (hParam == null) {
                System.out.println(
                ...
                System.out.println(
                        "Enter a valid timeStamp (from) as parameter for option -H (--history) ");
                return false;
        ...
        case 1:
            ...
            if (param == null || (wParam.size() > param.size())) {
                System.out
                        .println(
                                "One or more channels to write in are missing as parameter for option -c (--channel)");
                return false;
            } else if (wParam == null || wParam.size() < param.size()) {
                System.out.println(
                        "One or more values to write are missing as parameter for option -w (--write)");
                return false;
            } else {
                int i = 0;
                for (String chId : param) {
        ...
        case 2:
            ...
            if (param == null || gParam.size() > param.size()) {
                System.out
                        .println(
                                "One or more channels to get config information from are missing as parameter for option -c (--channel)");
                return false;
        ...
        case 4:
            ...
            if (param == null) {
                System.out.println(
                        "Option -c (--channel) needs one channel to set config information to");
                return false;
